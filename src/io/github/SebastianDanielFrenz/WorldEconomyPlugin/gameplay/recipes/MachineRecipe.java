...
public enum MachineRecipe {
	...
	CRUSHING____COAL_ORE____COAL__COBBLESTONE(new CustomItemStack[] { new CustomItemStack(CustomItem.COAL_ORE, 1) },
			new CustomItemStack[] { new CustomItemStack(CustomItem.COAL, 1), new CustomItemStack(CustomItem.COBBLESTONE, 1) }, 20),
	...
	FORGING____IRON_PLATE__IRON_ROD____IRON_PICKAXE(
			new CustomItemStack[] { new CustomItemStack(CustomItem.IRON_ROD, 4), new CustomItemStack(CustomItem.IRON_PLATE, 1) },
	...
	// dirt processing
	SIEVING____COARSE_DIRT____COBBLESTONE__DIRT(new CustomItemStack[] { new CustomItemStack(CustomItem.COARSE_DIRT, 16) },
			new CustomItemStack[] { new CustomItemStack(CustomItem.COBBLESTONE, 1), new CustomItemStack(CustomItem.DIRT, 16) }, 12),
