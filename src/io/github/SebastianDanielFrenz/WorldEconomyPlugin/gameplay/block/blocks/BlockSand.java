...
public class BlockSand extends CustomBlock {
	...
	public BlockSand() {
		super("sand", Material.SAND, true,
				new CustomBlockDropTable(new CustomBlockDrop[] { new CustomBlockDrop(CustomToolType.SHOVEL,
						CustomMaterialLevel.WOOD, new CustomItemStack[] { new CustomItemStack(CustomItem.SAND, 1) }) }),
