...
import io.github.SebastianDanielFrenz.WorldEconomyPlugin.gameplay.block.blocks.machines.MachineCategory;
	...
	public void onPlayerInteractEvent(PlayerInteractEvent event) {
		new CraftingGUI(new GUIItem[] { new GUIItem(4, WEGUI.mkItem(Material.OAK_SIGN, getName())) {
			...
			public void event(InventoryClickEvent event) {
				...
				new CampfireDecorationGUIItem(5, 5) }, "Furnace", event.getClickedBlock(),
