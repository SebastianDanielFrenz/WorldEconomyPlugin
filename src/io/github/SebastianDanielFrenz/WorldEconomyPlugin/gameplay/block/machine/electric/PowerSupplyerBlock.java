...
public abstract class PowerSupplyerBlock extends CustomBlockType {

	public PowerSupplyerBlock(Plugin plugin, String ID, Material material, int data, boolean vanilla,
