...
//	MOSSY_COBBLESTONE(Material.MOSSY_COBBLESTONE, Tiers.TIER1 + "MOSSY_COBBLESTONE");
...
//	COBBLESTONE_STAIRS(Material.COBBLESTONE_STAIRS, Tiers.TIER1 + "COBBLESTONE_STAIRS");
...
//	NETHER_BRICK_STAIRS(Material.NETHER_BRICK_STAIRS, Tiers.TIER1 + "NETHER_BRICK_STAIRS");
//	NETHER_WARTS(Material.NETHER_WARTS, Tiers.TIER1 + "NETHER_WARTS");
//	ENCHANTMENT_TABLE(Material.ENCHANTMENT_TABLE, Tiers.TIER1 + "ENCHANTMENT_TABLE");
...
//	ENDER_PORTAL_FRAME(Material.ENDER_PORTAL_FRAME, Tiers.TIER1 + "ENDER_PORTAL_FRAME");
//	ENDER_STONE(Material.ENDER_STONE, Tiers.TIER1 + "ENDER_STONE");
//	DRAGON_EGG(Material.DRAGON_EGG, Tiers.TIER1 + "DRAGON_EGG");
//	REDSTONE_LAMP_OFF(Material.REDSTONE_LAMP_OFF, Tiers.TIER1 + "REDSTONE_LAMP_OFF");
//	REDSTONE_LAMP_ON(Material.REDSTONE_LAMP_ON, Tiers.TIER1 + "REDSTONE_LAMP_ON");
//	WOODEN_DOUBLE_STEP(Material.WOODEN_DOUBLE_STEP, Tiers.TIER1 + "WOODEN_DOUBLE_STEP");
//	WOODEN_STEP(Material.WOODEN_STEP, Tiers.TIER1 + "WOODEN_STEP");
//	COCOA(Material.COCOA, Tiers.TIER1 + "COCOA");
//	SANDSTONE_STAIRS(Material.SANDSTONE_STAIRS, Tiers.TIER1 + "SANDSTONE_STAIRS");
...
//	SPRUCE_WOODEN_STAIRS(Material.SPRUCE_WOODEN_STAIRS, Tiers.TIER1 + "SPRUCE_WOODEN_STAIRS");
//	BIRCH_WOODEN_STAIRS(Material.BIRCH_WOODEN_STAIRS, Tiers.TIER1 + "BIRCH_WOODEN_STAIRS");
//	JUNGLE_WOODEN_STAIRS(Material.JUNGLE_WOODEN_STAIRS, Tiers.TIER1 + "JUNGLE_WOODEN_STAIRS");
...
//	REDSTONE_COMPARATOR_OFF(Material.REDSTONE_COMPARATOR_OFF, Tiers.TIER1 + "REDSTONE_COMPARATOR_OFF");
//	REDSTONE_COMPARATOR_ON(Material.REDSTONE_COMPARATOR_ON, Tiers.TIER1 + "REDSTONE_COMPARATOR_ON");
//	DAYLIGHT_DETECTOR(Material.DAYLIGHT_DETECTOR, Tiers.TIER1 + "DAYLIGHT_DETECTOR");
...
//	STAINED_GLASS_PANE(Material.STAINED_GLASS_PANE, Tiers.TIER1 + "STAINED_GLASS_PANE");
...
//	DARK_OAK_STAIRS(Material.DARK_OAK_STAIRS, Tiers.TIER1 + "DARK_OAK_STAIRS");
...
//	FLINT_AND_STEEL(Material.FLINT_AND_STEEL, Tiers.TIER1 + "FLINT_AND_STEEL");
...
//	DIAMOND_PICKAXE(Material.DIAMOND_PICKAXE, Tiers.TIER1 + "DIAMOND_PICKAXE");
...
//	LEATHER_CHESTPLATE(Material.LEATHER_CHESTPLATE, Tiers.TIER1 + "LEATHER_CHESTPLATE");
//	LEATHER_LEGGINGS(Material.LEATHER_LEGGINGS, Tiers.TIER1 + "LEATHER_LEGGINGS");
//	LEATHER_BOOTS(Material.LEATHER_BOOTS, Tiers.TIER1 + "LEATHER_BOOTS");
//	CHAINMAIL_HELMET(Material.CHAINMAIL_HELMET, Tiers.TIER1 + "CHAINMAIL_HELMET");
//	CHAINMAIL_CHESTPLATE(Material.CHAINMAIL_CHESTPLATE, Tiers.TIER1 + "CHAINMAIL_CHESTPLATE");
//	CHAINMAIL_LEGGINGS(Material.CHAINMAIL_LEGGINGS, Tiers.TIER1 + "CHAINMAIL_LEGGINGS");
//	CHAINMAIL_BOOTS(Material.CHAINMAIL_BOOTS, Tiers.TIER1 + "CHAINMAIL_BOOTS");
//	IRON_HELMET(Material.IRON_HELMET, Tiers.TIER1 + "IRON_HELMET");
//	IRON_CHESTPLATE(Material.IRON_CHESTPLATE, Tiers.TIER1 + "IRON_CHESTPLATE");
...
//	DIAMOND_CHESTPLATE(Material.DIAMOND_CHESTPLATE, Tiers.TIER1 + "DIAMOND_CHESTPLATE");
//	DIAMOND_LEGGINGS(Material.DIAMOND_LEGGINGS, Tiers.TIER1 + "DIAMOND_LEGGINGS");
...
//	GOLDEN_CHESTPLATE(Material.GOLDEN_CHESTPLATE, Tiers.TIER1 + "GOLDEN_CHESTPLATE");
//	GOLDEN_LEGGINGS(Material.GOLDEN_LEGGINGS, Tiers.TIER1 + "GOLDEN_LEGGINGS");
...
//	STORAGE_MINECART(Material.STORAGE_MINECART, Tiers.TIER1 + "STORAGE_MINECART");
//	POWERED_MINECART(Material.POWERED_MINECART, Tiers.TIER1 + "POWERED_MINECART");
...
//	FERMENTED_SPIDER_EYE(Material.FERMENTED_SPIDER_EYE, Tiers.TIER1 + "FERMENTED_SPIDER_EYE");
//	BLAZE_POWDER(Material.BLAZE_POWDER, Tiers.TIER1 + "BLAZE_POWDER");
//	MAGMA_CREAM(Material.MAGMA_CREAM, Tiers.TIER1 + "MAGMA_CREAM");
//	BREWING_STAND_ITEM(Material.BREWING_STAND_ITEM, Tiers.TIER1 + "BREWING_STAND_ITEM");
...
//	FLOWER_POT_ITEM(Material.FLOWER_POT_ITEM, Tiers.TIER1 + "FLOWER_POT_ITEM");
...
//	POISONOUS_POTATO(Material.POISONOUS_POTATO, Tiers.TIER1 + "POISONOUS_POTATO");
...
//	FIREWORK_CHARGE(Material.FIREWORK_CHARGE, Tiers.TIER1 + "FIREWORK_CHARGE");
//	ENCHANTED_BOOK(Material.ENCHANTED_BOOK, Tiers.TIER1 + "ENCHANTED_BOOK");
//	REDSTONE_COMPARATOR(Material.REDSTONE_COMPARATOR, Tiers.TIER1 + "REDSTONE_COMPARATOR");
//	NETHER_BRICK_ITEM(Material.NETHER_BRICK_ITEM, Tiers.TIER1 + "NETHER_BRICK_ITEM");
//	QUARTZ(Material.QUARTZ, Tiers.TIER1 + "QUARTZ");
//	EXPLOSIVE_MINECART(Material.EXPLOSIVE_MINECART, Tiers.TIER1 + "EXPLOSIVE_MINECART");
//	HOPPER_MINECART(Material.HOPPER_MINECART, Tiers.TIER1 + "HOPPER_MINECART");
...
//	DIAMOND_BARDING(Material.DIAMOND_BARDING, Tiers.TIER1 + "DIAMOND_BARDING");
