...
public class RecipesRegistry {
	...
	public static MachineRecipe CRUSHING____COAL_ORE____COAL__COBBLESTONE = new MachineRecipe(
			new CustomItemStack[] { new CustomItemStack(CustomItems.COAL_ORE, 1) }, new CustomItemStack[] {
					new CustomItemStack(CustomItems.COAL, 1), new CustomItemStack(CustomItems.COBBLESTONE, 1) },
			20);
	...
	public static MachineRecipe FORGING____IRON_PLATE__IRON_ROD____IRON_PICKAXE = new MachineRecipe(
			new CustomItemStack[] { new CustomItemStack(CustomItems.IRON_ROD, 4),
					new CustomItemStack(CustomItems.IRON_PLATE, 1) },
